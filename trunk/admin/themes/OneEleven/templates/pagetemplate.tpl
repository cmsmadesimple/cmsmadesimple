...
<html lang="{$lang|truncate:'2':''}" dir="{$lang_dir}">
  <head>
    ...
    <meta name="generator" content="CMS Made Simple - Copyright (C) 2004-22 CMS Made Simple Foundation. All rights reserved.">
    ...
    <![endif]-->
    <!-- custom jQueryUI Theme 1.12.1 see link in UI Stylesheet for color reference //-->
    ...
    <link href="{$config.admin_url}/themes/OneEleven/css/default-cmsms/jquery-ui-1.12.1.min.css" rel="stylesheet">
