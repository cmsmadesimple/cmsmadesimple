...
$lang['error_timedifference'] = "File system time is different than server time. This may cause problems when publishing i.e. news articles.";
...
$lang['installfileexists'] = '<em><strongWarning:</strong></em> The installation assistant file: %s still exists in the root directory.  As this could potentially be a security vulnerability, please delete it.';
