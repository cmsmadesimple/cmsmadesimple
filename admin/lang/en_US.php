...
$lang['accountupdated'] = "User account has been updated.";
$lang['action'] = "Action";
$lang['actioncontains'] = "Action Contains";
$lang['actionstatus'] = "Action/Status";
$lang['active'] = "Active";
$lang['add'] = "Add";
$lang['addbookmark'] = "Add Shortcut";
...
$lang['adminlogcleared'] = "The Admin Log was successfully cleared";
$lang['adminlogdescription'] = "This logs Admin activity and shows i.e. content changes, user information, and time of access.";
$lang['adminlogempty'] = "The Admin Log is empty";
$lang['adminlog_1day'] = "1 day";
$lang['adminlog_1month'] = "1 month";
$lang['adminlog_1week'] = "1 week";
$lang['adminlog_2weeks'] = "2 weeks";
$lang['adminlog_3months'] = "3 months";
$lang['adminlog_6months'] = "6 months";
$lang['adminlog_lifetime'] = "Lifetime of log-entries";
$lang['adminlog_manual'] = "Manual deletion";
$lang['adminpaging'] = "Number of Content Items to show per page in Page List";
$lang['adminpaneltitle'] = "CMS Made Simple&trade; Admin Console";
$lang['adminplugin'] = "Admin Plugin";
$lang['adminprefs'] = "User Preferences";
$lang['adminprefsdescription'] = "Here you set your specific preferences for site administration";
...
$lang['always'] = "Always";
$lang['apc_function'] = 'Test if APC caching functionality is available';
$lang['apc_not_available'] = 'APC Functionality not available';
...
//$lang['attachstylesheets'] = "Attach Stylesheets";
//$lang['attachtemplate'] = "Attach to this Template";
//$lang['attachtotemplate'] = "Attach Stylesheet to Template";
$lang['author'] = "Author";
$lang['autoclearcache'] = "Automatically clear the cache every <em>N</em> days";
...
//$lang['blobs'] = "Global Content Blocks";
$lang['bookmarks'] = "Shortcuts";
$lang['browser_cache_expiry'] = "Browser Cache Expiry Period <em>(minutes)</em>";
$lang['browser_cache_settings'] = "Browser Cache Settings";
$lang['bulk_success'] = "Bulk operation was successfully performed";
...
$lang['ce_navdisplay'] = "Content list navigation display";
...
$lang['CMSEX_L002'] = "Attempt to delete a lock when it has yet to be saved";
$lang['CMSEX_L003'] = "Lock type empty";
$lang['CMSEX_L004'] = "Lock not saved";
$lang['CMSEX_L005'] = "Could not find a lock with the specified identifiers";
$lang['CMSEX_L006'] = "Lock is owned by a different user. We cannot manipulate it";
$lang['CMSEX_L007'] = "Other/unknown locking error";
$lang['CMSEX_L008'] = "Locking exception";
$lang['CMSEX_L009'] = "Problem removing lock";
$lang['CMSEX_L010'] = 'Sorry, This item is locked, and cannot be edited at this time.  Additionally, only expired locks can be removed.';
...
$lang['CMSEX_XML003'] = "XML file is incomplete or invalid";
$lang['cms_install_information'] = "CMS Made Simple Install Information";
...
$lang['cron_6h'] = "6 Hours";
$lang['cron_12h'] = "12 Hours";
$lang['cron_15m'] = "15 Minutes";
$lang['cron_24h'] = "24 Hours";
$lang['cron_30m'] = "30 Minutes";
$lang['cron_60m'] = "1 Hour";
$lang['cron_120m'] = "2 Hours";
$lang['cron_request'] = "Each Request";
$lang['CSS'] = "CSS";
$lang['cssalreadyused'] = "CSS name already in use";
$lang['cssmanagement'] = "CSS Management";
$lang['cssnameisblockname'] = "Use the block id as the default value for the CSS name parameter in content blocks";
...
$lang['default_charset'] = 'Is the default character-set UTF-8';
...
$lang['edit'] = "Edit";
$lang['editbookmark'] = "Edit Shortcut";
...
$lang['emptyblock'] = "Empty content block: %s";
$lang['enable'] = "Enable";
...
//$lang['errorcopyingstylesheet'] = "Error Copying Stylesheet";
...
//$lang['errortemplateinuse'] = "This template is still in use by one or more pages. Please remove it first.";
...
$lang['error_nomodules'] = "No modules installed! Check Site Admin > Module Manager";
$lang['error_notconfirmed'] = "Operation not confirmed";
$lang['error_no_content_blocks'] = "No content blocks were detected in this template.  Please ensure that you have at least the default {content} block defined in this template";
...
$lang['error_objectcantsetthis'] = "You cannot adjust the %s property of this object";
$lang['error_parsing_content_blocks'] = "An error occurred parsing content blocks (look for an invalid template, or duplicated content blocks)";
$lang['error_passwordrequired'] = "A <b>password</b> is required for SMTP authentication";
...
$lang['false'] = "False";
$lang['filecreatedirbadchars'] = "Invalid characters were detected in the submitted directory name";
//$lang['filecreatedirnodoubledot'] = "Directory cannot contain .. (double dots)";
$lang['filecreatedirnoname'] = "Cannot create a directory with no name.";
//$lang['filecreatedirnoslash'] = "Directory name can not contain a / or \ character.";
$lang['filemanagement'] = "File Management";
$lang['filemanager'] = "File Manager";
$lang['filemanagerdescription'] = "Upload and manage files.";
...
$lang['hasdependents'] = "Has Dependants";
...
$lang['help_content_cachable'] = "This toggle indicates whether the content of this page can be cached by the browser.  If a page is not cachable, then it must be regenerated on each and every request.  Setting a page to be cachable can be a significant performance boost for most websites.";
...
$lang['help_page_default'] = 'Check this checkbox to set this page as the default page';
$lang['help_title_page_default'] = 'Default content page';
$lang['help_page_wantschildren'] = 'Specifies whether this page accepts child pages.  If disabled, no new page can be created as a child of this page, and you cannot re-order pages to set them as a child of this page.';
...
$lang['help_title_content_cachable'] = 'Cachable toggle';
$lang['help_title_content_extra1'] = 'Extra1 field';
$lang['help_title_content_extra2'] = 'Extra2 field';
$lang['help_title_content_extra3'] = 'Extra3 field';
$lang['help_title_content_image'] = 'Image selector';
$lang['help_title_content_menutext'] = 'Page Menu Text field';
$lang['help_title_content_owner'] = 'Owner selector';
$lang['help_title_content_pagedata'] = 'Page Specific Smarty';
$lang['help_title_content_pagemeta'] = 'Page Metadata field';
$lang['help_title_content_parent'] = 'Parent Page selector';
$lang['help_title_content_secure'] = 'Secure toggle';
$lang['help_title_content_showinmenu'] = 'Show in Menu toggle';
$lang['help_title_content_ta'] = 'Title Attribute field';
$lang['help_title_content_tabindex'] = 'Tab Index field';
...
$lang['image'] = "Image";
//$lang['imagemanagement'] = "Image Management";
//$lang['imagemanager'] = "Image Manager";
//$lang['imagemanagerdescription'] = "Upload/edit and remove images.";
...
$lang['info_cache_ttl'] = 'The amount of time that an item can be cached for';
...
//$lang['lctitle_move'] = "Allows arranging your content hierarchy";
//$lang['lctitle_multiselect'] = "Select all visible items / Select none";
//$lang['lctitle_owner'] = "The owner of the content item";
//$lang['lctitle_page'] = "The title of existing content items";
//$lang['lctitle_template'] = "The selected template for the content item. Some content items do not have templates";
//$lang['lctitle_url'] = "The URL suffix for the content item.  If set";
$lang['lines_in_error'] = "%d lines with errors";
//$lang['listcontent_settings'] = "Content List Settings";
//$lang['listcontent_showalias'] = "Display the &quot;Alias&quot; column";
//$lang['listcontent_showtitle'] = "Display the Page Title or Menu Text";
//$lang['listcontent_showurl'] = "Display the &quot;URL&quot; column";
//$lang['listgcbs_pagelimit'] = "Number of rows per page when viewing Global Content Blocks";
//$lang['liststylesheets'] = "Stylesheets";
...
$lang['moduledecides'] = "Module Decides";
$lang['moduledescription'] = "Modules extend CMS Made Simple&trade; to provide all kinds of custom functionality.";
$lang['moduleerrormessage'] = "Error Message for %s Module";
$lang['modulehelp'] = "Help for the %s module";
$lang['modulehelp_english'] = "View In English";
$lang['modulehelp_yourlang'] = "View in Your Language";
...
$lang['modulesnotwritable'] = "The modules folder <em>(and/or the uploads folder)</em> is not writeable, if you would like to install modules by uploading an XML file you need ensure that these folders have full read/write/execute permissions (chmod 777).  Safe mode may also be in effect.";
$lang['moduleuninstallmessage'] = "Uninstall Message for %s Module";
$lang['moduleupgraded'] = "Upgrade Successful";
...
$lang['msg_userdeleted'] = 'Selected user account successfully deleted.';
...
$lang['msg_usersettingscleared'] = "User settings cleared";
$lang['msg_usersettingscopied'] = "User settings copied from template user account";
...
$lang['new_version_avail2'] = '<strong>Notice:</strong> You are currently running CMSMS version %s. Version %s is available.  Please upgrade soon.';
...
$lang['nopluginabout'] = "No about information available for this plugin";
$lang['nopluginhelp'] = "No help available for this plugin";
...
$lang['pagedata'] = "Smarty data or logic that is specific to this page";
...
$lang['pagedefaultsupdated'] = "Page default settings updated";
$lang['pagelink_circular'] = "A page link cannot list another page link as its destination";
$lang['pagemetadata'] = "Page Specific Metadata";
$lang['pages'] = "Pages";
$lang['pagesdescription'] = "This is where we add and edit pages and other content.";
...
$lang['period_decade'] = "decade";
$lang['period_decades'] = "decades";
$lang['period_fmt'] = "%d %s %s";
$lang['period_fromnow'] = "from now";
$lang['period_hour'] = "hour";
$lang['period_hours'] = "hours";
$lang['period_min'] = "minute";
$lang['period_mins'] = "minutes";
$lang['period_month'] = "month";
$lang['period_months'] = "months";
$lang['period_sec'] = "second";
$lang['period_secs'] = "seconds";
$lang['period_week'] = "week";
$lang['period_weeks'] = "weeks";
$lang['period_year'] = "year";
$lang['period_years'] = "years";
...
$lang['perm_Advanced_usage_of_the_File_Manager_module'] = 'Advanced usage of the File Manager module';
$lang['perm_Approve_News_For_Frontend_Display'] = 'Approve News for Frontend Display'; // should go in News
...
$lang['permdesc_Modify_Any_Page'] = 'A user with this permission has additional editor privileges on all content pages';
$lang['perm_Modify_Events'] = 'Modify Events';
...
$lang['perm_Use_Admin_Search'] = 'Use Admin Search';
...
$lang['preferencesdescription'] = "This is where you set various site-wide preferences.";
$lang['prefsupdated'] = "User preferences have been updated.";
$lang['prettyurls_noeffect'] = "Pretty URLS are not configured... this URL will have no effect";
$lang['preview'] = "Preview";
$lang['previewdescription'] = "Preview changes";
$lang['previous'] = "Previous";
$lang['profile'] = "Profile";
$lang['prompt_defaultcontent'] = 'This page is the default content page';
$lang['prompt_smarty_cachemodules'] = "Cache module calls";
$lang['prompt_smarty_cacheudt'] = "Cache UDT Calls";
$lang['prompt_smarty_compilecheck'] = "Do a Compilation Check";
$lang['prompt_use_smartycaching'] = "Enable Smarty Caching";
$lang['pseudocron_granularity'] = "Pseudocron Granularity";
...
$lang['run'] = "Run";
$lang['runuserplugin'] = "Save, and execute this user defined tag";
$lang['run_udt'] = "Run this User Defined Tag";
...
$lang['server_cache_settings'] = "Server Cache Settings";
$lang['server_db_grants'] = "Check database access levels";
...
$lang['settings_authentication'] = "Authentication";
$lang['settings_authpassword'] = "Password";
$lang['settings_authsecure'] = "Encryption method";
$lang['settings_authusername'] = "User name";
$lang['settings_mailer'] = "Mailer";
$lang['settings_mailfrom'] = "From Address";
$lang['settings_mailfromuser'] = "From Name";
$lang['settings_sendmailpath'] = "Sendmail Path";
$lang['settings_smtpauth'] = "SMTP Authentication is Required";
$lang['settings_smtphost'] = "SMTP Hostname";
$lang['settings_smtpport'] = "SMTP Port";
$lang['settings_smtptimeout'] = "SMTP Time-out (seconds)";
$lang['settings_testaddress'] = "Email Address";
$lang['settrue'] = "Set True";
$lang['setup'] = "Advanced Setup";
//$lang['setusersettings'] = "Set this user account to be the template";
$lang['showall'] = "Show All";
$lang['showbookmarks'] = "Show Admin Bookmarks";
$lang['showfilters'] = "Edit filter";
...
$lang['sitedown_settings'] = "Maintenance Mode";
$lang['sitename'] = "Site Name";
$lang['siteprefs'] = "Global Settings";
$lang['siteprefsupdated'] = "Global Settings Updated";
$lang['siteprefs_confirm'] = "Are you sure you want to alter these settings?";
$lang['smarty_settings'] = "Smarty Settings";
...
$lang['stylesheetcopied'] = "Stylesheet Copied";
$lang['stylesheetexists'] = "Stylesheet Exists";
$lang['stylesheetnotfound'] = "Stylesheet %d not found";
$lang['stylesheets'] = "Stylesheets";
$lang['stylesheetsdescription'] = "Stylesheet management is an advanced way to handle cascading Stylesheets (CSS) separately from templates.";
$lang['stylesheetstodelete'] = "These stylesheets will be deleted";
*/
$lang['subitems'] = "Subitems";
$lang['submit'] = "Submit";
...
$lang['sysmain_str_errors'] = "Structural errors detected in tables";
$lang['sysmain_tablesfound'] = "tables found (out of which %d are not seq-tables)";
$lang['sysmain_tablesoptimized'] = "Tables optimized";
$lang['sysmain_tablesrepaired'] = "Tables repaired";
$lang['sysmain_typesfixed'] = "page content types fixed";
$lang['sysmain_update'] = "Update";
$lang['sysmain_updatehierarchy'] = "Update page hierarchy positions";
$lang['sysmain_updateurls'] = "Update Routes";
...
$lang['systemmaintenancedescription'] = "Various functions for maintaining the health of your system. You can also browse the changelog for all releases.";
$lang['system_verification'] = "System Verification";

## T
$lang['tabindex'] = "Tab Index";
$lang['tagdescription'] = "Tags are little bits of PHP functionality that can be added to your content and/or templates.";
$lang['tags'] = "Tags";
...
$lang['test'] = "Test";
$lang['testmsg_success'] = "Test message sent... check your inbox.";
$lang['test_allow_browser_cache'] = "Allowing browsers to cache pages will improve performance by not requiring your system to serve the page on repeated visits to a page.";
$lang['test_allow_old_mact'] = 'The system is currently capable of parsing old style mact requests.  This is considered less secure.  Please disable allow_old_mact in the config.php';
$lang['test_generate_old_mact'] = 'The system is currently generating old style mact requests.  This is considered less secure.  Please disable generate_old_mact in the config.php';
...
$lang['title_hierselect_select'] = 'Select a content page. If the selected page has children a new dropdown will appear.  Selecting "None" indicates that the selection stops with the value of the previous select if any.';
...
//$lang['uninstalled_mod'] = "Uninstalled module %s";
$lang['unknown'] = "Unknown";
$lang['unlimited'] = "Unlimited";
$lang['untested'] = "Not Tested";
$lang['up'] = "Up";
$lang['updateperm'] = "Update Permissions";
...
$lang['upload_largeupload'] = 'The total size of files to upload exceeds the limit specified in the PHP configuration';
...
$lang['user_logout'] = "User Logout";
$lang['user_tag'] = "User Tag";
$lang['usewysiwyg'] = "Use WYSIWYG editor for content";
$lang['use_name'] = "In the parent page dropdown, show the page title instead of the menu text";
...
## Y
$lang['yes'] = "Yes";
$lang['your_ipaddress'] = "Your IP Address is";
