...
$lang['apply'] = 'Apply';
$lang['approve'] = 'Draft | Change status to \'Published\'';
...
$lang['info_url_prefix'] = 'This only applies when pretty urls are enabled either via mod_rewrite or internal pretty urls. Additionally, this value is not used when a custom URL is specified for an individual News article.';
...
$lang['title_url_prefix'] = 'Prefix to use on all URLs from the News module';
$lang['type'] = 'Type';
