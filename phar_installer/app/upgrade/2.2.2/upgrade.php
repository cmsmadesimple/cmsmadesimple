...
if( $tmp < 1 ) {
    ...
    $sql = 'INSERT INTO '.CMS_DB_PREFIX.'permissions (permission_id,permission_name,permission_source,create_date,modified_date)
            VALUES (?,?,?,NOW(),NOW())';
    $db->Execute( $sql, [ $new_id, 'Manage Users', 'Core'] );
}
