...
final class content_plugins
{
    ...
    private static $_primary_content_done;    // generated by preprocess_mact
    ...
    public static function get_default_content_block_content( $page_id, &$smarty)
    {
        ...
        $result = null;
        if( self::$_primary_content_done ) return self::$_primary_content;
	...
	self::$_primary_content_done = true;
        return $result;
    }
} // end of class.
