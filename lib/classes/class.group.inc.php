...
class Group
{
     ...
     * @ignore
     */
    private $data = ['id'=>-1,'name'=>null,'description'=>null,'active'=>false];
    ...
    {
        if( !array_key_exists($key,$this->data) ) throw new \LogicException($key.' is not a member of '.__CLASS__);
