...
try {
    // if we already have template types by this originator, we skip this part
    $types = CmsLayoutTemplateType::load_all_by_originator('Search');
    if( empty($types) ) {
        ...
        // this should be in the simplex theme.
        try {
