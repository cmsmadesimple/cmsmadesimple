...
$lang['param_detailpage'] = 'Used only for matching results from modules, this parameter allows specifying a different detail page for the results.  This is useful if, for example, you always display your detail views in a page with a different template.  <em>(<strong>Note:</strong> modules have the ability to override this parameter.)</em>.  This parameter is passed from the Search tag to the dosearch action.';
$lang['param_formtemplate'] = 'Used only for the default action, this parameter allows specyfing the name of a non default template.  It is possible to use any smarty resource string here.';
...
$lang['param_modules'] = 'Limit search results to values indexed from the specified (comma separated) list of modules.  This parameter is passed through from the Search module tag to the dosearch action.';
...
$lang['param_passthru'] = 'Pass named parameters down to specified modules.  The format of each of these parameters is: "passtru_MODULENAME_PARAMNAME=\'value\'" i.e.: passthru_News_detailpage=\'newsdetails\'".  These parameters can be passed through from the Search module call to the dosearch action.';
...
$lang['param_searchtext'] = 'Text to place into the search box <em>(deprecated, please just modify the search template)</em>';
$lang['param_submit'] = 'Text to place into the submit button <em>(deprecated, please just modify the search template)</em>';
$lang['param_uselike'] = 'A parameter to allow searching for words beginning with the entered text.  This parameter is passed from the Search tag to the dosearch action.';
