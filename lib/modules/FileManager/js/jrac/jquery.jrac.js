  ...
  $.fn.jrac = function(options) {
    ...
    return this.each(function() {
      ...
      var image_load_handler = function(){
        ...
        if (!jrac_loaded) {
          var $zoom_widget = $('<div class="jrac_zoom_slider"><div class="ui-slider-handle"></div></div>').appendTo($container);
	  $zoom_widget.width($viewport.width())
          .slider({
            value: $image.width(),
          ...
          var $crop = $('<div class="jrac_crop"><div class="jrac_crop_drag_handler"></div></div>').appendTo($image);
	  $crop.css({
