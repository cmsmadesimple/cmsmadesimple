...
class tar_file extends archive
{
    ...
    function createwholedir($name) {
        //echo "$name</br>";
        $pos=0;
        while (($pos=strpos($name,'/',$pos))) {
            $dir=substr($name,0,$pos);
            if (!is_dir($dir)) @mkdir($dir);
            //echo "<b>".substr($name,0,$pos)."</b>";
            $pos++;
        }
    }
                ...
                if ($this->options['inmemory'] == 1)
                {
                    ...
                    else if ($file['type'] == 2)
                    {
                        if (!$iswindows) {
                         ...
                         if (file_exists($file['name'])) @unlink($file['name']);
                    ...
                    if (!$iswindows) {
                          ...
                          @touch($file['name'], $file['stat'][9]); //doesn't work on windows machines, generating warnings
                    }
                    unset ($file);
                }
            }
