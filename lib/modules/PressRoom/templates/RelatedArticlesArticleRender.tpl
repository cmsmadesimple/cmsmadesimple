<script>
$(function(){
   var _url = '{cms_action_url module=PressRoom action=admin_ajax_relatedarticles forjs=1}&showtemplate=false'
   var _id = '#_{$def->name}'
   ...
   if( _value && _value.length > 0 ) {
      ...
      $.ajax({
         url: '{cms_action_url module=PressRoom action='admin_ajax_getarticlelist' forjs=1}&showtemplate=false&list=' + _value.join(',')
      }).then(function(data){
