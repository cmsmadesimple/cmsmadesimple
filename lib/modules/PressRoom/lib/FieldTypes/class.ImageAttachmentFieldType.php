...
class ImageAttachmentFieldType extends FieldType
{
    ...
    {
        return $this->mod->Lang('fldtype_imageattachment');
    }
    ...
    public function renderForArticle( FieldDef $def, $value )
    {
        ...
        $tpl = $smarty->createTemplate( $this->mod->GetTemplateResource('ImageAttachmentFieldArticleRender.tpl'));
