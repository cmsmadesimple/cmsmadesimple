...
class AdminHookHandler
{
    ...
    public function __construct( PressRoom $mod, Settings $settings, ArticleManager $artm )
    {
        ...
        $hm->emit( 'PressRoom::afterSaveArticle', [ $this, 'afterSaveArticle_Search'] );
