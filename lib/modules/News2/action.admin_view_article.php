...
try {
    ...
    if( $this->CheckPermission( News2::MANAGE_PERM ) || $this->CheckPermission( News2::APPROVE_PERM) ) {
        // nothing
    ...
    $tpl->assign('can_approve',
                 $article->status == $article::STATUS_NEEDSAPPROVAL &&
                 ($this->CheckPermission( News2::MANAGE_PERM ) || $this->CheckPermission( News2::APPROVE_PERM) ) );
    $tpl->display();
}
catch( \Exception $e ) {
