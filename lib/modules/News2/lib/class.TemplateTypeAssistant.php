...
final class TemplateTypeAssistant
{
    ...
    public static function reset_page_type_defaults(CmsLayoutTemplateType $type)
    {
        ...
        if( $type->get_originator() != 'News2' ) throw new CmsLogicException('Cannot reset contents for this template type');
    ...
    public static function create_dm_types()
    {
        ...
        $summary_template_type->set_lang_callback('News2\\TemplateTypeAssistant::page_type_lang_callback');
        $summary_template_type->set_content_callback('News2\\TemplateTypeAssistant::reset_page_type_defaults');
        $summary_template_type->set_help_callback('News2\\TemplateTypeAssistant::template_help_callback');
        ...
        $detail_template_type->set_lang_callback('News2\\TemplateTypeAssistant::page_type_lang_callback');
        $detail_template_type->set_content_callback('News2\\TemplateTypeAssistant::reset_page_type_defaults');
        $detail_template_type->set_help_callback('News2\\TemplateTypeAssistant::template_help_callback');
        ...
        $showcategories_template_type->set_lang_callback('News2\\TemplateTypeAssistant::page_type_lang_callback');
        $showcategories_template_type->set_content_callback('News2\\TemplateTypeAssistant::reset_page_type_defaults');
        $showcategories_template_type->set_help_callback('News2\\TemplateTypeAssistant::template_help_callback');
