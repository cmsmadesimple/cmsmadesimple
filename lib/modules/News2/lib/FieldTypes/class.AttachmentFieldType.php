...
class AttachmentFieldType extends FieldType
{
    private $mod;
    ...
    {
        return $this->mod->Lang('fldtype_attachment');
    }
    ...
    public function renderForArticle( FieldDef $def, $value )
    {
        ...
        $tpl = $smarty->createTemplate( $this->mod->GetTemplateResource('AttachmentFieldArticleRender.tpl'));
