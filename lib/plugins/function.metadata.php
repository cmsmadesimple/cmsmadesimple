...
function smarty_function_metadata($params, &$smarty)
{
    ...
    $hookmanager->emit('metadata_prerender', [ 'content_id'=>$content_obj->Id(), 'showbase'=>&$showbase, 'html'=>&$result ]);
    ...
    $hookmanager->emit('metadata_postrender', [ 'content_id'=>$content_obj->Id(), 'html'=>&$result ]);
